...
class Player:
    def __init__(self, speed=2):
        ...
        self.image = pygame.image.load("resources/images/ash_alone.png")
        self.rect = None
        self.speed = speed
        self.health = Health()
...
class App:
    ...
    def summon_pokemon(self):
        self.flag = False
        self.pokemons.append(Pokemon(list([self.width, random.randint(50, self.height - 200)]), random.uniform(0.5,1.3)))
